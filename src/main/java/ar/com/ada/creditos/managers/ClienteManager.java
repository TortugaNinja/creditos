...
public class ClienteManager {
    ...
    public List<Cliente> buscarPor(String nombre) {
        ...
        // "SELECT * FROM cliente where nombre = "' or '1'='1"; UPDATE prestamo set importe = 10000"

        // MIDDLEWARD 
        //Peticion peticion = session.usarPeticion("BUSCARCLIENTES"); 
        //peticion.agregarParametro(nombre);
        //peticion.ejecutar();
        // es una pequeña aplicacion que evita devolver datos de la base de datos.
