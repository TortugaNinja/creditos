...
public class Cliente {
    ...
    @OneToMany(mappedBy = "cliente", cascade = CascadeType.ALL, fetch = FetchType.EAGER) //mapea al objeto relacionado con la tabla. Es decir, al objeto "Cliente" en la clase Prestamo.
